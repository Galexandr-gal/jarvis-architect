...
export const VOICE_FALLBACK_PROMPT =
  "🎤 Русскоязычные голосовые сообщения уже поддерживаются.\n\n" +
  "Сейчас распознавание ещё не настроено, поэтому бот пока не может перевести голос в текст.\n\n" +
  "Выбери один из вариантов:\n\n" +
  "<b>Deepgram</b> — самый быстрый способ: облачное распознавание на русском, точное и без ручной установки.\n\n" +
  "<b>Whisper</b> — бесплатная локальная установка на сервер, но требует чуть больше времени.";
